import{j as e}from"./index-B-XQBK-R.js";import{C as t}from"./Callout-Bs-TwcD9.js";import{C as s}from"./CodeBlock-BD7B4F1R.js";import{u as a}from"./useTranslation-BPySU2ZA.js";import"./createLucideIcon-BfmU6-uQ.js";import"./triangle-alert-CspxHpG9.js";import"./copy-BEf8BVlI.js";const n=`import { v, schema, validateRequest } from "skyguard-js";
...
v.string().url()
v.string().uuid()
v.string().regex(/^[a-z]+$/)`,r=`v.number()
v.number({ max: 5 })
v.number({ min: 10 })
v.number({ integer: true })
v.number({ positive: true })
v.number({ negative: true })`,c="v.boolean()",d=`v.bigint()
v.bigint({ gt: 5n })
v.bigint({ gte: 6n })
v.bigint({ lt: 4n })
v.bigint({ lte: 7n })
