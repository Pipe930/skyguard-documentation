...
const codeExampleCsrfBasic = `import { csrf } from "skyguard-js";
...
const codeExampleCsrfHandlebars = `import { createApp, csrf } from "skyguard-js";
...
const codeExampleCsrfTemplate = `<form action="/transfer" method="POST">
  <input type="hidden" name="csrf" value="{{csrfToken}}" />
  <input type="number" name="amount" />
  <button type="submit">Send</button>
</form>`;

const codeExampleCsrfFetch = `<script>
